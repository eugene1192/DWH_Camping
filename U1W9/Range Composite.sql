...
ALTER TABLE sales
      ADD PARTITION oct06 VALUES LESS THAN ( '01-OCT-2008' )
      TABLESPACE SYSTEM;
...
--------------------------------------------------------------------------------
CREATE TABLESPACE i_gear1
DATAFILE '/oracle/u01/app/oracle/oradata/DCORCL/pdb_evrublevskiy/i_gear1.dat'
SIZE 20M
 AUTOEXTEND ON NEXT 5M
 SEGMENT SPACE MANAGEMENT AUTO;
 
 CREATE TABLESPACE i_gear2
DATAFILE '/oracle/u01/app/oracle/oradata/DCORCL/pdb_evrublevskiy/i_gear2.dat'
SIZE 20M
 AUTOEXTEND ON NEXT 5M
 SEGMENT SPACE MANAGEMENT AUTO;
 
 CREATE TABLESPACE i_gear3
DATAFILE '/oracle/u01/app/oracle/oradata/DCORCL/pdb_evrublevskiy/i_gear3.dat'
SIZE 20M
 AUTOEXTEND ON NEXT 5M
 SEGMENT SPACE MANAGEMENT AUTO;
 
 CREATE TABLESPACE i_gear4
DATAFILE '/oracle/u01/app/oracle/oradata/DCORCL/pdb_evrublevskiy/i_gear4.dat'
SIZE 20M
 AUTOEXTEND ON NEXT 5M
 SEGMENT SPACE MANAGEMENT AUTO;
...
LOCAL ( 
PARTITION gear1 TABLESPACE i_gear1,
PARTITION gear2 TABLESPACE i_gear2,
PARTITION gear3 TABLESPACE i_gear3,
PARTITION gear4 TABLESPACE i_gear4
);

ALTER TABLE four_seasons 
MERGE PARTITIONS gear1, gear2 INTO PARTITION gear2
UPDATE INDEXES;
...
ALTER TABLE sales    
   SPLIT PARTITION sales_q1_2006    VALUES LESS THAN ( TO_DATE('01-JUL-2006','dd-MON-yyyy'))
   INTO    
    ( PARTITION oct06_1, 
      PARTITION oct06_2)
--split      
      ALTER TABLE sales SPLIT PARTITION sales_q2_2006
  AT ('15-JUN-2006')
  INTO 
  (
    PARTITION sales_JUN_2006
 TABLESPACE system,
 PARTITION sales_JUL__2006
 TABLESPACE system
  ); 
