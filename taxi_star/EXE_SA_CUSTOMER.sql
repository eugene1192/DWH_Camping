...
CREATE INDEX sa_customer_idx 
    ON u_dw_ext_app.sa_customer(first_name, last_name, birth_date)
...
CREATE INDEX sa_driver_idx 
    ON u_dw_ext_app.sa_driver(first_name, last_name, birth_date,drive_licen)
TABLESPACE ts_sa_app_data;
