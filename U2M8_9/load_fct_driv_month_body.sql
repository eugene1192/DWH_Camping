CREATE OR REPLACE PACKAGE body load_fct_driv_moth
AS
    PROCEDURE load_fct_drv
        AS
            BEGIN                
                MERGE INTO u_dw_fct_tax.fct_driv_month f
                USING (WITH fct_drv_month AS
                            (
                            SELECT 
                                dat.date_id,
                                dat.month_id,
